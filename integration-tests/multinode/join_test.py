...
# FIXME wait for it clean up, remove after #1293 fixed
print('wait for cleanup', state['validator']['inactive_time'] + 20)
wait_for_blocktime(rpc, state['validator']['inactive_time'] + 20)
