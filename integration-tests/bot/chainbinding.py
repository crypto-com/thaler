...
dll.cro_jsonrpc_call.argtypes = dll.cro_jsonrpc_call.argtypes = [
...
dll.cro_jsonrpc_call.restype = dll.cro_jsonrpc_call.restype = ctypes.c_int

dll.cro_create_jsonrpc.argtypes = dll.cro_create_jsonrpc.argtypes = [
...
dll.cro_create_jsonrpc.restype = dll.cro_create_jsonrpc.restype = ctypes.c_int
...
class RpcBinding:
    def __init__(self, storage, tendermint_ws, network_id=0xab, mock_mode=False):
        create_jsonrpc = dll.cro_create_jsonrpc
