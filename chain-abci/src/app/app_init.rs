...
impl<T: EnclaveProxy> ChainNodeApp<T> {
    ...
    pub fn new_with_storage(tx_validator: T, gah: &str, chain_id: &str, storage: Storage) -> Self {
    ...
    pub fn new(tx_validator: T, gah: &str, chain_id: &str, storage_config: &StorageConfig) -> Self {
